...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <a class="navbar-brand" href="<%= request.getContextPath() %>/sample2/main">
    <img src="${pageContext.request.contextPath }/res/image/tube.png"  height="30" alt="">
  </a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <c:if test="${not empty sessionScope.userLogined }" >
        ...
        <a class="nav-link" href="<%= request.getContextPath() %>/sample2/member/logout"><i class="fas fa-sign-out-alt"></i>로그아웃</a>
            ...
            <li class="nav-item">
        <a class="nav-link" href="<%= request.getContextPath() %>/sample2/board/write"><i class="fas fa-pen"></i>글쓰기</a>
      </li>
            <li class="nav-item">
        <a class="nav-link" href="<%= request.getContextPath() %>/sample2/member/list"><i class="far fa-list-alt"></i>회원목록보기</a>
      </li>
      </c:if>
      
            <li class="nav-item">
        <a class="nav-link" href="<%= request.getContextPath()%>/sample2/board/list"><i class="fas fa-list-alt"></i>글목록보기</a>
      </li>
    </ul>
  </div>
</nav>